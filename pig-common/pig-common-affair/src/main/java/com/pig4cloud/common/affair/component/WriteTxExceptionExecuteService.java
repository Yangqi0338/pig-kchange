...
public class WriteTxExceptionExecuteService implements RpcExecuteService {
    ...
    public Serializable execute(TransactionCmd transactionCmd) throws TxManagerException {
        try {
            ...
            WriteTxExceptionDTO writeTxExceptionReq = WriteTxExceptionDTO.builder()
                    .modId(rpcClient.getAppName(transactionCmd.getRemoteKey()))
                    .build();
            ...
            writeTxExceptionReq.setGroupId(txExceptionParams.getGroupId()).setUnitId(txExceptionParams.getUnitId());
