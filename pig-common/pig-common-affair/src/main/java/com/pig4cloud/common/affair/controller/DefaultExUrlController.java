 ...
 */
package com.pig4cloud.common.affair.controller;
...
@RestController
@Slf4j
public class DefaultExUrlController {

    private final MailProperties mailProperties;
    private final JavaMailSender javaMailSender;

    public DefaultExUrlController(@Autowired(required = false) JavaMailSender javaMailSender,
                                  @Autowired(required = false) MailProperties mailProperties,
                                  @Autowired TxManagerProperties txManagerConfig) {
