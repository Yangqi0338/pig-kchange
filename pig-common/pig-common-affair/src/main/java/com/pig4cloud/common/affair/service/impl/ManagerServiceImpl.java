...
import com.pig4cloud.common.affair.interfaces.FastStorage;
...
public class ManagerServiceImpl implements ManagerService {
    ...
    private final TxManagerProperties managerConfig;

    @Autowired
    public ManagerServiceImpl(RpcClient rpcClient, FastStorage fastStorage, TxManagerProperties managerConfig) {
