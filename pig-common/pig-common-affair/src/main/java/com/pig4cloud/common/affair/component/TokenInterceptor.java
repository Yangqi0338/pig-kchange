...
import com.pig4cloud.common.affair.exception.SAuthHandleException;
import com.pig4cloud.common.affair.interfaces.SAuthLogic;
import com.pig4cloud.common.affair.vo.ErrorResponse;
...
public class TokenInterceptor implements HandlerInterceptor {
    ...
    @Autowired
    public TokenInterceptor(@Qualifier("txManagerAdminAuthLogic") SAuthLogic sAuthLogic) {
